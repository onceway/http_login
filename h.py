...
logfile = '/home/wangy/python/http/logc'                        # log文件路径
# holiday
holiday_file = '/home/wangy/python/http/holidayc'               # Holiday配置文件
# mail settings
...
# debug
debug_on = 1                                                    # 开启时无视“脚本开始等待时间”，不进行Record操作，不使用日志模式
